        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <ContainerFormLayout>
                <div className="mb-6 flex items-center justify-between">
                    <div className="">
                        <h1 className="text2xl mb-4 font-bold">Edit {String(batch.batch_number)}</h1>
                        <p className="text-muted-foreground mb-6 text-sm">Edit Batch Information</p>
                    </div>
                    <div className="">
                        <Link className={buttonVariants({ variant: 'secondary' })} href={route('batch.show', batch.id)}>
                            Back
                        </Link>
                    </div>
                </div>
                <form onSubmit={updateBatch} className="space-y-6">
                    <div className="grid gap-2">
                        <Label>Batch Number</Label>
                        <Input id="batch" value={batch.batch_number} className="mt-1 block w-full" disabled />
                    </div>
                    <div className="grid gap-2">
                        <Label>Product Name</Label>
                        <Input id="product" value={product.name} className="mt-1 block w-full" disabled />
                    </div>
                    <div className="grid gap-2">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="supplier" value={supplier.partner?.name} className="mt-1 block w-full" disabled />
                    </div>
